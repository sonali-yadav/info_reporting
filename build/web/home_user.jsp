...
<nav id="navbar">
    ...
    <div class="search_div">
        <form action="home_user.jsp" method="POST">
    ...
    <ul class="nav_list">
        <% String srch = request.getParameter("search");
            ...
            try {
                ...
                while (rs.next()) {%>
        <li>
            <form action="home_user.jsp" name="title_form" method="POST">
    ...
    <section class="table_section">
        <div class="table_div">
            ...
            <div class="table_header">
                ...
                <form action="archiverecords_user.jsp" method="POST" class="inline">
                    <input type="hidden" name="title" value=<%=request.getParameter("title")%>>
                    <input type="hidden" name="head" value=<%=request.getParameter("head")%>>
